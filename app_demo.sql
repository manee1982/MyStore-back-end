...
--
-- Host: localhost
-- Generation Time: Dec 10, 2018 at 05:35 PM
...
INSERT INTO `clothes` (`id`, `name`, `discription`, `image`) VALUES
(1, 'رمادري غامق', 'وصل حديثا للمخازن خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد', 'images/clothes/cell-1.png'),
(2, 'احمر فاقع', 'متوفر بمقاسات مختلفة خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد', 'images/clothes/cell-2.png'),
(3, 'بني جميل', 'متوفر الان بمالمعارض للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد', 'images/clothes/cell-3.png'),
(4, 'اخضر رنان', 'وصل حديثا للمعارض خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد', 'images/clothes/cell-4.png'),
(5, 'اسود فاتح', 'متوفر الان بالمعارض خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد', 'images/clothes/cell-5.png'),
(6, 'بنكي نسائي', 'متوفر الان بالمعارض خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد', 'images/clothes/cell-6.png');
...
(3, 'جاكت', 'منطقي قريب إلى النص الحقيقي. وبالتالي يكون النص الناتح خالي من التكرار، أو أي كلمات أو عبارات غير لائقة أو ما شابه', 'images/main/coll-1.png', 'جاكت'),
(4, 'مريحة', 'هذا القرن مع إصدار رقائق \"ليتراسيت\" (Letraset) البلاستيكية تحوي مقاطع من هذا النص، وعاد لينتشر مرة أخرى مؤخراَ مع ظهور برامج النشر الإلكتروني مثل', 'images/main/coll-2.png', 'فانلات'),
